...
3) Access the `workbench` named `chatbot-h1742385572372-notebook`.
...
5) In the terminal, run `cd chatbot-h1742385572372` to navigate to your sample app's directory.
